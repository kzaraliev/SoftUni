    ...
    public class HouseService : IHouseService
    {
        ...
        public async Task<HouseQueryServiceModel> AllAsync(string? category = null, string? searchTerm = null, HouseSorting sorting = HouseSorting.Newest, int currentPage = 1, int housesPerPage = 1)
        {
            ...
            housesToShow = sorting switch
            {
                ...
                HouseSorting.NotRentedFirst => housesToShow.OrderBy(h => h.RenterId != null).ThenByDescending(h => h.Id),
        ...
        public async Task<IEnumerable<HouseServiceModel>> AllHouseByAgentIdAsync(int agentId)
        {
        ...
        public async Task<HouseFormModel?> GetHouseFormModelModelByIdAsync(int id)
        {
