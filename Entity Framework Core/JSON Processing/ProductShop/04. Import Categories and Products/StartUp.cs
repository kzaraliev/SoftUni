...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            string inputJsonProductsCategory = File.ReadAllText(@"../../../Datasets/categories-products.json");
            string output = ImportCategoryProducts(context, inputJsonProductsCategory);
        ...
        {
            List<Category> categories = JsonConvert.DeserializeObject<List<Category>>(inputJson).Where(c => c.Name != null).ToList();
