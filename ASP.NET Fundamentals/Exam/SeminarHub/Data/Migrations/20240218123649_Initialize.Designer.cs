...
namespace SeminarHub.Data.Migrations
{
    ...
    [Migration("20240218123649_Initialize")]
            ...
            modelBuilder.Entity("SeminarHub.Data.Models.Seminar", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Orginizer")
                        .WithMany()
                        .HasForeignKey("OrginizerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Category");

                    b.Navigation("Orginizer");
                });
